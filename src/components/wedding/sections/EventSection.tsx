...
export function EventSection() {
  ...
  return (
    ...
    >
      ...
      <ParallaxElement
        speed={0.2}
        className="pointer-events-none absolute inset-x-0 bottom-6 mx-auto h-56 w-[min(96vw,760px)] text-sogan/25 sm:h-72"
      >
        <motion.div
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 md:gap-8">
          {events.map((event, i) => (
            <motion.article
              ...
              className="relative overflow-hidden border border-gold/35 bg-ivory/85 px-6 py-9 text-center backdrop-blur-sm hover-lift"
            >
              ...
              <div className="relative">
                ...
                <h3 className="mt-3 font-display text-3xl text-java-brown sm:text-4xl">
                  {event.name}
                </h3>
...
function DetailRow({
  ...
  return (
    <li className="flex items-start gap-3">
      ...
      <span className="font-sans text-[0.74rem] leading-relaxed text-java-brown/85">{text}</span>
    </li>
  );
}
